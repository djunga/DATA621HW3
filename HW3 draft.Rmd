...
### Model 1
```{r}
classification_table <- table(crime.train$target, crime.train$predict_prob_m1 > 0.5)
...
### Model 2
```{r}
classification_table <- table(crime.train$target, crime.train$predict_prob_m2 > 0.5)
classification_table
```
...
### Model 3
```{r}
classification_table <- table(crime.train$target, crime.train$predict_prob_m3 > 0.5)
classification_table
```
...
Probit Back
```{r}
classification_table <- table(crime.train$target, crime.train$predict_prob_back > 0.5)
classification_table
```
...
Probit Forward
```{r}
classification_table <- table(crime.train$target, crime.train$predict_prob_forward > 0.5)
classification_table
```
