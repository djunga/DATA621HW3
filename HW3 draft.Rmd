...
### Model 2
```{r}
classificationtable_2 <- table(crime.train$target, crime.train$predict_prob_m2 > 0.5)
classificationtable_2
```
...
### Model 3
```{r}
classificationtable_3 <- table(crime.train$target, crime.train$predict_prob_m3 > 0.5)
classificationtable_3
```
