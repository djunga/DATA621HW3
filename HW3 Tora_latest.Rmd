...
After the automated elimination of variables for the model, we wanted to compair the probit and logit models. 
...
forward
```{r, echo=FALSE}
sensitivity_prfor <- (classification_table_prfor[2,2]/(classification_table_prfor[2,2] + classification_table_prfor[2,1])) * 100
sensitivity_prfor
specificity_prfor <- (classification_table_prfor[1,1]/(classification_table_prfor[1,1] + classification_table_prfor[1,2])) * 100
specificity_prfor

```
backward
```{r, echo=FALSE}
sensitivity_proback <- (classification_table_prback[2,2]/(classification_table_prback[2,2] + classification_table_prback[2,1])) * 100
sensitivity_proback
specificity_proback <- (classification_table_prback[1,1]/(classification_table_prback[1,1] + classification_table_prback[1,2])) * 100
specificity_proback
```
